...
#define HM2_GTAG_XIOPORT           (88) // 0x58 'X'
...
// 
typedef struct {
                hal_bit_t *xioport_in[32];
                hal_bit_t *xioport_out[32];
               } hm2_xioport_instance_t ;

typedef struct {

    int num_instances ;

    hm2_xioport_instance_t *instance ;

    u32 written_buff ;

    u32 xioport_addr;
    u32 *xioport_read_reg;
    u32 *xioport_write_reg;
...
int hm2_xioport_parse_md(hostmot2_t *hm2, int md_index);
void hm2_xioport_cleanup(hostmot2_t *hm2);
//void hm2_xioport_force_write(hostmot2_t *hm2);
//void hm2_xioport_write(hostmot2_t *hm2);
//void hm2_xioport_print_module(hostmot2_t *hm2);
//void hm2_xioport_gpio_tram_write_init(hostmot2_t *hm2);

//int hm2_xioport_gpio_export_hal(hostmot2_t *hm2);
//void hm2_xioport_gpio_process_tram_read(hostmot2_t *hm2);
//void hm2_xioport_gpio_prepare_tram_write(hostmot2_t *hm2);

void hm2_xioport_read(hostmot2_t *hm2);
void hm2_xioport_write(hostmot2_t *hm2);
