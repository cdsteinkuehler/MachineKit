...
//    hm2->stepgen.step_rate_reg[i] = steps_per_sec_cmd * (4294967296.0 / (double)hm2->stepgen.clock_frequency);
    temp=steps_per_sec_cmd * (4294967296.0 / (double)hm2->stepgen.clock_frequency);
    if (temp < 0.0)
        hm2->stepgen.step_rate_reg[i]=(uint32_t)(int32_t)(floor(temp-0.5));
    else
        hm2->stepgen.step_rate_reg[i]=(uint32_t)(int32_t)(temp);
